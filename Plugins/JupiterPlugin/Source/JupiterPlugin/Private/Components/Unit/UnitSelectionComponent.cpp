...
namespace
{
    void ComputeSelectionDelta(const TArray<AActor*>& PreviousSelection, const TArray<AActor*>& NewSelection, TArray<AActor*>& OutAdded, TArray<AActor*>& OutRemoved)
    {
...
{
    if (APlayerController* Controller = ResolveOwnerController())
    {
